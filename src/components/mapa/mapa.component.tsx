...
const MapaComponent = () => {
    ...
    return (
        <section
            ...
            className={`sm:mt-0 mt-10 relative sm:w-[70%] w-full z-30 grid place-items-center content-center p-0  sm:min-h-screen sm:h-full h-full `}
        >
            <TitleComponent
            ...
            <div
                ref={refScreeen}
                className={`w-full  flex flex-row lg:justify-between justify-center gap-10 flex-wrap items-center sm:mt-20 mt-5 ${
                    isNearScreen ? "efecto-show" : "opacity-0"
                }`}
            >
                {/* */}
                <div className=" relative lg:w-[30%] sm:w-[60%] w-[90%] aspect-square overflow-hidden rounded-full shadow-header contenedor-mapa ">
                    <iframe
